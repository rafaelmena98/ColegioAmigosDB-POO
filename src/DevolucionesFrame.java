...
public class DevolucionesFrame extends JFrame {

    public DevolucionesFrame() {

        setTitle("Devoluciones - Sistema Biblioteca");
        setSize(850, 520);
        setLocationRelativeTo(null);
        setLayout(null);

        JLabel titulo = new JLabel("Devoluciones");
        titulo.setFont(new Font("Arial", Font.BOLD, 24));
        titulo.setBounds(350, 20, 200, 35);
        add(titulo);

        JLabel lblCampo1 = new JLabel("ID Préstamo:");
        ...
        JLabel lblCampo3 = new JLabel("Fecha devolución:");
        ...
        String[] columnas = {"Préstamo", "Ejemplar", "Fecha", "Estado"};
