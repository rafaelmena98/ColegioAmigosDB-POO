...
public class UsuariosFrame extends JFrame {
    ...
    public UsuariosFrame() {
        ...
        setTitle("Usuarios - Sistema Biblioteca");
        setSize(850, 520);
        ...
        JLabel lblCampo2 = new JLabel("Nombre:");
        ...
        JLabel lblCampo3 = new JLabel("Correo:");
        ...
        JLabel lblCampo4 = new JLabel("Tipo:");
        ...
        String[] columnas = {"ID", "Nombre", "Correo", "Tipo"};
