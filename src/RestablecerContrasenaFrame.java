...
public class RestablecerContrasenaFrame extends JFrame {
    ...
    public RestablecerContrasenaFrame() {
        ...
        setTitle("Restablecer contraseña - Sistema Biblioteca");
        setSize(850, 520);
        ...
        JLabel lblCampo2 = new JLabel("Nueva contraseña:");
        ...
        JLabel lblCampo3 = new JLabel("Confirmar contraseña:");
        ...
        String[] columnas = {"ID", "Usuario", "Estado", "Acción"};
