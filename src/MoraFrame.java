...
public class MoraFrame extends JFrame {

    public MoraFrame() {

        setTitle("Mora - Sistema Biblioteca");
        setSize(850, 520);
        setLocationRelativeTo(null);
        setLayout(null);

        JLabel titulo = new JLabel("Mora");
        titulo.setFont(new Font("Arial", Font.BOLD, 24));
        titulo.setBounds(390, 20, 200, 35);
        add(titulo);
        ...
        JLabel lblCampo2 = new JLabel("Días atraso:");
        ...
        JLabel lblCampo3 = new JLabel("Monto mora:");
        ...
        String[] columnas = {"Préstamo", "Días", "Mora", "Estado"};
