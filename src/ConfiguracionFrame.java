...
public class ConfiguracionFrame extends JFrame {
    ...
    public ConfiguracionFrame() {
        ...
        setTitle("Configuración - Sistema Biblioteca");
        setSize(850, 520);
        ...
        JLabel lblCampo1 = new JLabel("Parámetro:");
        ...
        JLabel lblCampo2 = new JLabel("Valor:");
        ...
        JLabel lblCampo3 = new JLabel("Descripción:");
        ...
        String[] columnas = {"Parámetro", "Valor", "Descripción", "Estado"};
